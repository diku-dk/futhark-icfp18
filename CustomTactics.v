(* =========================================== *)
(* Selected tactics from Software Foundations  *)
(* =========================================== *)
...
(** A tactic for repeatedly destructing all existentials in hypothesis [H], 
    creating new variables with the [n] prefix *)
Ltac dest_exs H n :=
  match goal with
...
(** A tactic for repeatedly destructing all existentials in current context, 
    creating new hypothesis with [Hn n] prefix and variables with the [n] prefix *)
